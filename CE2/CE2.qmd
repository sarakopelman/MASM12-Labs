...
plot(1:n, Phi, type="l", main="Phi (drift dominates, full process)", xlab="t", ylab="Phi_t (latent)")
dev.off()

png("drift_y_full.png", width=800, height=600)
plot(1:n, y,   type="l", main="y (drift dominates, full process)", xlab="t", ylab="y_t (observed)")
dev.off()
...
plot(1:n, Phi, type="l", main="Phi (phi dominates, full process)", xlab="t", ylab="Phi_t (latent)")
dev.off()

png("phi_y_full.png", width=800, height=600)
plot(1:n, y,   type="l", main="y (phi dominates, full process)", xlab="t", ylab="y_t (observed)")
dev.off()

png("phi_Phi_zoom.png", width=800, height=600)
plot(900:1000, Phi[900:1000], type="l", main="Phi (phi dominates, t=900–1000)", xlab="t", ylab="Phi_t (latent)")
dev.off()

png("phi_y_zoom.png", width=800, height=600)
plot(900:1000, y[900:1000],  type="l", main="y (phi dominates, t=900–1000)", xlab="t", ylab="y_t (observed)")
dev.off()
...
plot(1:n, Phi, type="l", main="Phi (noise dominates, full process)", xlab="t", ylab="Phi_t (latent)")
dev.off()

png("noise_y_full.png", width=800, height=600)
plot(1:n, y,   type="l", main="y (noise dominates, full process)", xlab="t", ylab="y_t (observed)")
dev.off()

png("noise_Phi_zoom.png", width=800, height=600)
plot(900:1000, Phi[900:1000], type="l", main="Phi (noise dominates, t=900–1000)", xlab="t", ylab="Phi_t (latent)")
dev.off()

png("noise_y_zoom.png", width=800, height=600)
plot(900:1000, y[900:1000],  type="l", main="y (noise dominates, t=900–1000)", xlab="t", ylab="y_t (observed)")
dev.off()
