sde4room_base2 <- function(data){
  ...
  model$addSystem(
    dTi1 ~ 1/Ci1*( 1/Ria*(Ta-Ti1) + 1/Rim*(Tm1-Ti1) + 1/R12*(Ti1-Ti2) + frac1*Ph1 + Aw1*Gv)*dt 
    + exp(logsigma_i)*dw1
  )
  model$addSystem(
  ...
  model$addSystem(
    dTi2 ~ 1/Ci2*( 1/Ria*(Ta-Ti2) + 1/Rim*(Tm2-Ti2) + 1/R12*(Ti1-Ti2) + 1/R23*(Ti2-Ti3) + (1-frac1)*Ph1 + Aw2*Gv)*dt 
    + exp(logsigma_i)*dw3
  )
  model$addSystem(
  ...
  model$addSystem(
    dTi3 ~ 1/Ci3*( 1/Ria*(Ta-Ti3) + 1/Rim*(Tm3-Ti3) + 1/R23*(Ti2-Ti3) + 1/R34*(Ti3-Ti4) + frac2*Ph2 + Aw3*Gv)*dt 
    + exp(logsigma_i)*dw5
  )
  model$addSystem(
  ...
  model$addSystem(
    dTi4 ~ 1/Ci4*( 1/Ria*(Ta-Ti4) + 1/Rim*(Tm4-Ti4) + 1/R34*(Ti3-Ti4) + (1-frac2)*Ph2 + Aw4*Gv)*dt 
    + exp(logsigma_i)*dw7
  )
  model$addSystem(
  ...
  model$setParameter(Ti2 = c(init = 15, lb = 0, ub = 40))
  model$setParameter(Tm2 = c(init = 15, lb = 0, ub = 40))
  model$setParameter(Ti3 = c(init = 15, lb = 0, ub = 40))
  model$setParameter(Tm3 = c(init = 15, lb = 0, ub = 40))
  model$setParameter(Ti4 = c(init = 15, lb = 0, ub = 40))
  model$setParameter(Tm4 = c(init = 15, lb = 0, ub = 40))
  ##----------------------------------------------------------------
  # Set the initial value for the optimization
  model$setParameter(Ci1 = c(init = 1, lb = 1E-5, ub = 1E5))
  model$setParameter(Ci2 = c(init = 1, lb = 1E-5, ub = 1E5))
  model$setParameter(Ci3 = c(init = 1, lb = 1E-5, ub = 1E5))
  model$setParameter(Ci4 = c(init = 1, lb = 1E-5, ub = 1E5))
  
  model$setParameter(Cm1 = c(init = 1000, lb = 1E-5, ub = 1E5))
  model$setParameter(Cm2 = c(init = 1000, lb = 1E-5, ub = 1E5))
  model$setParameter(Cm3 = c(init = 1000, lb = 1E-5, ub = 1E5))
  model$setParameter(Cm4 = c(init = 1000, lb = 1E-5, ub = 1E5))
  ...
  model$setParameter(logsigma_i = c(init = 1, lb = -30, ub = 10))
  model$setParameter(logsigma_m = c(init = 1, lb = -30, ub = 10))
  model$setParameter(meas_var = c(init = -1, lb = -50, ub = 10))
  
  model$setParameter(frac1 = c(init = 1/2, lb = 1E-2, ub = 0.99))
  model$setParameter(frac2 = c(init = 1/2, lb = 1E-2, ub = 0.99))
